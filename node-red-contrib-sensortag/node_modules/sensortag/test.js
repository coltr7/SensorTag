      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.readIrTemperature(function(error, objectTemperature, ambientTemperature) {
			...
			tagOutput.oTemp = objectTemperature.toFixed(1);
			tagOutput.aTemp = ambientTemperature.toFixed(1);
            callback();
          });
        } else {
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.readAccelerometer(function(error, x, y, z) {
			...
			tagOutput.x = x.toFixed(1);
			tagOutput.y = y.toFixed(1);
			tagOutput.z = z.toFixed(1);
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.readHumidity(function(error, temperature, humidity) {
			...
			tagOutput.temp = temperature.toFixed(1);
			tagOutput.humidity = humidity.toFixed(1);
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.readMagnetometer(function(error, x, y, z) {
			...
			tagOutput.magX = x.toFixed(1);
			tagOutput.magY = y.toFixed(1);
			tagOutput.magZ = z.toFixed(1);
            callback();
          });
        } else {
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.readBarometricPressure(function(error, pressure) {
			...
			tagOutput.pressure = pressure.toFixed(1);
      ...
      function(callback) {
        if (USE_READ) {
          ...
          sensorTag.readGyroscope(function(error, x, y, z) {
			...
			tagOutput.gyroX = x.toFixed(1);
			tagOutput.gyroY = y.toFixed(1);
			tagOutput.gyroZ = z.toFixed(1);
          ...
          async.series([
            ...
            function(callback) {
              ...
              sensorTag.readTestConfiguration(function(error, configuration) {
				...
				tagOutput.config = configuration;

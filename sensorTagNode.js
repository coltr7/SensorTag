  ...
  var tagOutput = {};
	...
	function SensorTagNode( n ) {
		...
		var tagOptionFields = [ "temperature" , "pressure" , "humidity" , "accelerometer" , "magnetometer" , "gyroscope" , "luxometer" , "keys" ,
		                        "magnetometerPeriod" , "accelerometerPeriod" , "gyroscopePeriod" , "luxometerPeriod", "all" ];
...
//colton programmed
	SensorTagNode.prototype.sendAllData = function( uuid , sensorName , sensorID , data )
	{
		var now = ( new Date() ).getTime();
...
//
	...
	{
		tagOutput.objectTemp = object;
		tagOutput.ambientTemp = ambient;
	...
	{
		tagOutput.accelerometerX = x;
		tagOutput.accelerometerY = y;
		tagOutput.accelerometerZ = z;
	...
	{
		tagOutput.temperature = temperature;
		tagOutput.humidity = humidity;
...
//
	Tag.prototype.sendAll = function (tagOutput)
	{
		//this.log(tagOutput);
		this.parent.sendAllData( this.tag.uuid , "all" , 8 , tagOutput );
	}
//
